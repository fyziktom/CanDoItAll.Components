...
public sealed class FileBrowserContentLease : IAsyncDisposable
{
    ...
    public ValueTask DisposeAsync()
        => ownsStream ? Stream.DisposeAsync() : ValueTask.CompletedTask;
}
