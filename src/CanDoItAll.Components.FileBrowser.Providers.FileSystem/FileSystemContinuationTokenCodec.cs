...
internal static class FileSystemContinuationTokenCodec
{
        ...
        string consistencyToken)
    {
        ...
        try
        {
            ...
            {
                throw new FormatException("The continuation token is too large.");
            }
            ...
            {
                throw new FormatException("The continuation token contains trailing data.");
            }
        ...
        catch (Exception exception) when (exception is FormatException or EndOfStreamException or IOException or DecoderFallbackException)
        {
            throw StaleCursor("The filesystem continuation token is invalid.", exception);
        }
    ...
    private static FileBrowserProviderException StaleCursor(string message, Exception? exception = null)
        => new(
