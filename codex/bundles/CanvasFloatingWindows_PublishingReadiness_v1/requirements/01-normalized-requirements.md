...
| R10 | Validate Canvas floating windows and OverlayWindow open states across container/safe-top, resize, drag, minimize, restore, reset, hide, and long content. | SB07 | SB07 | Browser proof captures both `route groups/overlays` and `route groups/canvas` states with clipping/layering/state assertions. |
...
| R14 | Keep Canvas, floating-window, calendar, preview, and related runtime implementation pure browser JavaScript plus C# and Razor with no new npm runtime dependencies. | README, SB04, SB06, SB07, SB09, SB10 | SB04, SB06, SB07, SB09, SB10 | Source and package assertions prove no new npm runtime package is introduced; npm use is limited to existing Tailwind, generated asset, test, or browser tooling. |
...
- Do not add npm runtime dependencies for Canvas, floating-window, calendar, preview, or related interactive implementation.
