...
Document WebGlLib-only, WebGlRunLib, domain driver, production-line canary, package mode, RC validation and post-freeze governance.
...
6. Produce proof artifacts under `proof/SB19/`.
...
- `proof/SB19/transcripts/*.txt`
- `proof/SB19/changed-file-hashes.txt`
