...
Ensure browser observer proof uses real browser-loaded document hash, runtime diagnostics, UI proof, screenshot and object-position export.
...
6. Produce proof artifacts under `proof/SB16/`.
...
- `proof/SB16/transcripts/*.txt`
- `proof/SB16/changed-file-hashes.txt`
