...
Approve window.CanDoItAll.webglScene by behavior contract: parameters, return shape, missing-runtime behavior, lifecycle state and failure semantics.
...
6. Produce proof artifacts under `proof/SB06/`.
