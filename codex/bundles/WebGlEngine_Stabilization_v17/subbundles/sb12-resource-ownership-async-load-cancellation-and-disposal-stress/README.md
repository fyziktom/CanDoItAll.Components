...
Prove late GLB load cannot attach to disposed state; verify material/texture ownership and pending disposal diagnostics.
...
6. Produce proof artifacts under `proof/SB12/`.
...
- `proof/SB12/changed-file-hashes.txt`
