# SB11: Domain driver contract RC

## Objective

Freeze domain driver contract for future Economy and production-line consumers.

## Scope

IWebGlRunDomainMappingDriver, manifest, driver hash, metadata scrubber, driver versioning

## Constraints

No generic interpretation of driver action names or driver ids.

## Required validation

driver validator tests and manifest approvals

## Required proof artifacts

domain-driver-rc-report.md
