# SB07 — Browser observer proof must use exported runtime state
...
## Required proof
Observer proof fails on deliberately mismatched document/hash; passes on actual runtime export.
