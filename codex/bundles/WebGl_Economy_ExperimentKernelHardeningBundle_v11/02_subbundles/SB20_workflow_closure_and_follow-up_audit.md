# SB20 â€” Workflow closure and follow-up audit
...
Close raw findings one by one, update proof manifests, semantic invariants, changed-file hashes, source assertions, and execution report.
...
- `proof/SB20/semantic-invariants.md`
