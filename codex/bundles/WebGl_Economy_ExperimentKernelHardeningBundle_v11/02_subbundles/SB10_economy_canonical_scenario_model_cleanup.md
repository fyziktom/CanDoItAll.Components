# SB10 â€” Economy canonical scenario model cleanup
...
Make canonical fields explicit and aliases compatibility-only. Normalize with diagnostics and prevent hash drift from alias conflicts.
