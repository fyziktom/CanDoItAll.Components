# SB14 â€” Economy policy/rules expansion
...
Implement generic behavior/rule expansion from institution.rules.json to events: tax/fee/admin/rule-check/rule-violation/rule-enforcement.
