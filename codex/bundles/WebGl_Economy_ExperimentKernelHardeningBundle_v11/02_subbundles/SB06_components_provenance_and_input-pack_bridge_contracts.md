# SB06 â€” Components provenance and input-pack bridge contracts
...
Keep generic RunSourceRef/InputRef contracts but harden validation for hashes/schema versions and forbid domain metadata in WebGlRunDocument.
