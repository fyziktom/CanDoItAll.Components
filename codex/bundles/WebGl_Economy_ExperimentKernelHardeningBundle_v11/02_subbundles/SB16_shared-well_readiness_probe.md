# SB16 â€” Shared-well readiness probe
...
No demo. Prove that input pack can express near/far households, inventory build, resale, tax/fee/admin, and fair-use enforcement without hardcoded special cases.
