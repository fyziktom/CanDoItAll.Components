# SB18 â€” Cross-repo bridge design only
...
Document how Economy visual actions will later map into WebGlRun actions. No project reference between repos yet.
...
- `proof/SB18/semantic-invariants.md`
