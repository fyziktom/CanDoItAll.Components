# SB07 â€” Components performance gates
...
Large-screen benchmark: 500 objects, 1000 staged actions, 1000 motions. Measure interop calls, batch normalization time, render idle state, and memory disposal.
