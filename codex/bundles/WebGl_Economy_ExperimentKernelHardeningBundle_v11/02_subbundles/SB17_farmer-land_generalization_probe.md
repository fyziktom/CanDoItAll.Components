# SB17 â€” Farmer-land generalization probe
...
Add a minimal JSON input pack fixture for finite land expansion/anti-oligarchy rules; use it to validate generic engine concepts, not to build UI.
...
- `proof/SB17/semantic-invariants.md`
