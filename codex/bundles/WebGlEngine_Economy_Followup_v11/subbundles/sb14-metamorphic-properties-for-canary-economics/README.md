# SB14 — Metamorphic properties for canary economics
...
Add properties for multi-goods-elite: more investment changes dependency/concentration, higher fee changes liquidity, adding duplicated neutral actor does not alter unrelated totals.
...
- `proof/SB14/manifest.md` updated with artifact paths, commands, and pass/fail status.

## Semantic invariants

- Catch simulator bugs that pass single golden examples.
...
- `SB14_FocusedContractTests`
- `SB14_BoundaryAuditTests`
- `SB14_ProofArtifactValidationTests`
