...
public sealed class ComponentsPackageScopeTests
{
    ...
    public void Package_intent_is_explicit_for_solution_projects()
    {
        ...
        var expected = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["samples/CanDoItAll.Components.Sandbox/CanDoItAll.Components.Sandbox.csproj"] = "false",
            ...
            ["samples/CanDoItAll.Components.WebGlSandbox/CanDoItAll.Components.WebGlSandbox.csproj"] = "false",
